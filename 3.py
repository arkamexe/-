...
#getting the date data to cooperate
    day = i + 1
    if day < 10:
...
#getting data from api
    ...
    #I am adding this print to look less boring while requesting data and calculating the statistics
    print("\n", daysData[i])

#forming data so that I can claculate statistics outside of loop
...
#using data to calculate statistics
maxNum = 0
maxNumKeys = []
maxBonus = 0
maxBonusKeys = []
for i in range(1, 81, 1):
#finding the number/s that appear most frequently
...
#finding the bonus number/s that appear most frequently
...
#finding which number/s from odds and evens appear most frequently
maxOdd = 0
maxEven = 0
maxOddKeys = []
maxEvenKeys = []
...
#finding which parity won most times overall
